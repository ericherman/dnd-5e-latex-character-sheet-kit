...
% Luckstone and similar may have a Saving Throw modifier
\ifthenelse{\isundefined{\DndSaveMod}}{\FPeval{\DndSaveMod}{0}}{}

\FPeval{\DndStrSave}{clip(
	\DndSaveMod + \DndStrMod + (\DndIsProficientStr * \DndProficiencyMod))}
\FPeval{\DndDexSave}{clip(
	\DndSaveMod + \DndDexMod + (\DndIsProficientDex * \DndProficiencyMod))}
\FPeval{\DndConSave}{clip(
	\DndSaveMod + \DndConMod + (\DndIsProficientCon * \DndProficiencyMod))}
\FPeval{\DndIntSave}{clip(
	\DndSaveMod + \DndIntMod + (\DndIsProficientInt * \DndProficiencyMod))}
\FPeval{\DndWisSave}{clip(
	\DndSaveMod + \DndWisMod + (\DndIsProficientWis * \DndProficiencyMod))}
\FPeval{\DndChaSave}{clip(
	\DndSaveMod + \DndChaMod + (\DndIsProficientCha * \DndProficiencyMod))}

% Luckstone and similar may have an modifier
\ifthenelse{\isundefined{\DndSkillMod}}{\FPeval{\DndSkillMod}{0}}{}
